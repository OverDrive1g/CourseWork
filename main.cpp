...
//    вывод отсортированного списка в разрезе подразделения
...
int main() {
	...
	while (true) {
		...
		GotoXY(3, 2); cout << "Вывод сотрудников по подразделению" << endl;
		GotoXY(3, 3); cout << "Добавить запись сотрудника" << endl;
		GotoXY(3, 4); cout << "Удалить запись сотрудника" << endl;
		GotoXY(3, 5); cout << "Изменить запись сотрудника" << endl;

		GotoXY(3, 6); cout << "Вывод всех профессий" << endl;
		GotoXY(3, 7); cout << "Добавить запись профессию" << endl;
		GotoXY(3, 8); cout << "Удалить запись профессии" << endl;
		GotoXY(3, 9); cout << "Изменить запись профессии" << endl;

		GotoXY(3, 10); cout << "Выход" << endl;
		drawMenu(choice);
		switch (_getch()) {
		case 56: 
			if(choice - 1 > 0)
