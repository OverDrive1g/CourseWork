...
int main() {
	...
	while (true) {
		...
		GotoXY(3, 5); cout << "Вывод всех профессий" << endl;
		GotoXY(3, 6); cout << "Добавить запись профессию" << endl;
		GotoXY(3, 7); cout << "Удалить запись профессии" << endl;
		GotoXY(3, 8); cout << "Изменить запись профессии" << endl;

		GotoXY(3, 9); cout << "Выход" << endl;
		drawMenu(choice);
		switch (_getch()) {
		case 56: 
			if(choice - 1 > 0)
